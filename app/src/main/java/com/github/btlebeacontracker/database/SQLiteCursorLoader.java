...
public class SQLiteCursorLoader extends AbstractCursorLoader {
    ...
    private ContentChangingTask buildInsertTask(SQLiteCursorLoader loader) {
        return (new InsertTask(loader));
    }

    private ContentChangingTask buildUpdateTask(SQLiteCursorLoader loader) {
        return (new UpdateTask(loader));
    }

    private ContentChangingTask buildReplaceTask(SQLiteCursorLoader loader) {
        return (new ReplaceTask(loader));
    }

    private ContentChangingTask buildDeleteTask(SQLiteCursorLoader loader) {
        return (new DeleteTask(loader));
    }

    private ContentChangingTask buildExecSQLTask(SQLiteCursorLoader loader) {
        return (new ExecSQLTask(loader));
    }

    static class InsertTask extends ContentChangingTask {
    ...
    static class UpdateTask extends ContentChangingTask {
    ...
    static class ReplaceTask extends ContentChangingTask {
    ...
    static class DeleteTask extends ContentChangingTask {
    ...
    static class ExecSQLTask extends ContentChangingTask {
